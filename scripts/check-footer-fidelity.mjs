...
const checks = [
  ...
  ["CTA pill geometry (13px/700, 10px 16px, r10, gold border)", css.includes(".fpush { font: inherit; font-size: 13px; font-weight: 700; line-height: 1; letter-spacing: 0.01em; padding: 10px 16px; border-radius: 10px; cursor: pointer; border: 1px solid var(--gold-border); background: var(--dark-s); color: var(--gold-b);")],
  ["CTA hover = solid gold, dark ink", css.includes(".fpush:hover { border-color: var(--gold-b); background: var(--gold-b); color: #0d0b08; transform: translateY(-1px); }")],
